...
public class PlayerController : MonoBehaviour, IEnemy
{
	...
	private void Jump()
	{
		...
		{
			rbody.velocity = new Vector3(rbody.velocity.x, 0f);
			rbody.AddForce(Vector3.up * jumpForce);
		}
	}

	private bool GroundCheck() =>
		Physics.CheckSphere(groundCheckPoint.position, groundCheckSphereRadius, groundLayer.value);
	...
	private void OnDrawGizmos()
	{
		...
		Gizmos.DrawWireSphere(groundCheckPoint.position, groundCheckSphereRadius);
	}
